...
<title>Students Portal - Add College</title>
...
<div id="container">
    ...
    <div id="nav">
    	<ul class="sf-menu dropdown">
			...
			<li class="selected"><a href="add_college.php">Add College</a></li>
...
<?php
	...
	<fieldset align="center" >
					...
					<form action="add_college.php" method="post" >
						...
						<input name="college_id" id="name" Placeholder="College ID" type="text" /><br /></p>		
						<p><label for="college_name">College Name:</label>
						<input name="college_name" id="email" Placeholder="College Name" type="text" /><br /></p>
						<p><input name="add" class="formbutton" value="Add College" type="submit" /></p>
					</form>
				</fieldset>
<?php
		if(isset($_POST['college_id']) && isset($_POST['college_name']))
		{
			$college_id= $_POST['college_id'];
			$college_name= $_POST['college_name'];
			if(!empty($_POST['college_id']) && !empty($_POST['college_name']))
			{
				$query="INSERT INTO college_details VALUES('".mysql_real_escape_string($college_id)."','".mysql_real_escape_string($college_name)."')";
				if($query_run= mysql_query($query))
				{
					echo '<p align="center"><font color="red"> College Details Entered Successfully.  Now enter branch details. </font></p>';				
				}
				else
				{
					echo '<p align="center"><font color="red"> Not Registered due to some error !!!. May be you have entered an already existing College ID. Try again with avalid College ID.</font></p>';
				}
