...
<title>Students Portal - Add Branch</title>
...
<div id="container">
    ...
    <div id="nav">
    	<ul class="sf-menu dropdown">
			...
			<li class="selected"><a href="add_branch.php">Add Branch</a></li>
...
<?php
	...
	}else
	{
		...
		{
			echo '<p align="center"><font color="red"><br /><br /> College details found successfully.<br> </font></p>';
	?>
	
	<fieldset align="center" >
					<legend>Add Branch Details:</legend>
					<form action="add_branch1.php" method="post" >
						<p><label for="branch_name">Enter Branch:</label>
						<input name="branch_name" Placeholder="Branch Name" type="text" /><br /></p>
						<p><input  class="formbutton" value="ADD Branch" type="submit" /></p>
					</form>
				</fieldset>
				<br /><br />
<?php
					if(isset($_POST['branch_name']))
					{
						if(!empty($_POST['branch_name']) )
						{
							...
							$query="INSERT INTO branch_details VALUES ('','".mysql_real_escape_string($college_id)."','".mysql_real_escape_string($branch)."')";
							if($query_run=mysql_query($query))
							{
								echo '<p align="center"><font color="red"> Branch added Successfully!!!!.<br> <br /></font></p>';
								unset($_SESSION['college_id']);
								header('Location: add_branch.php');
							}
							else
							{
								echo '<p align="center"><font color="red"> Some error occured in updating branch!!!! </font></p>';
							}
