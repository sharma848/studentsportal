...
<fieldset align="center" >
					...
					<form action="add_branch.php" method="get" >
						<p><label for="college_id">Enter College ID:</label>
...
<?php
		if(isset($_GET['college_id']))
		{
			if(!empty($_GET['college_id']))
			{
				...
				$query="SELECT college_id FROM college_details WHERE college_id='".mysql_real_escape_string($college_id)."'"; 
				$query_run=mysql_query($query);
				$query_num=mysql_num_rows($query_run);
				if($query_num==1)
				{
					echo '<p align="center"><font color="red"> College details found successfully.<br> </font></p>';
					$_SESSION['college_id']=$college_id;
					header('Location: add_branch1.php');
				}
				else
				{
					echo '<p align="center"><font color="red"> College Details Not Entered. First enter the college details. | <a href="add_college.php">Add College</a></font></p>';
				}
			}
			else
			{
