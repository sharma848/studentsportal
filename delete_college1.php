...
<title>Students Portal - Delete College Data</title>
...
<div id="container">
    ...
    <div id="nav">
    	<ul class="sf-menu dropdown">
			...
			<li class="selected"><a  href="delete_college.php">Delete College</a></li>
	...
	<div id="body">
        <div id="breadcrumbs">
            ...
            <strong>Delete College Data</strong>
        </div>
...
<?php
	...
	{
		if(isset($_SESSION['collegeiddelete']))
		{
			
			$collegeiddelete=$_SESSION['collegeiddelete'];
			echo '<p align="center"><font color="red"> College ID Found Valid <br><br> </font></p>';
							
			$query="DELETE FROM college_details WHERE college_id='".mysql_real_escape_string($collegeiddelete)."'";
			if($query_run=mysql_query($query))
			{
				$query1="DELETE FROM branch_details WHERE college_id='".mysql_real_escape_string($collegeiddelete)."'";
				if($query_run1=mysql_query($query1))
				{
					echo '<p align="center"><font color="red"><br /><br /> College Details Deleted Successfully !!!  | <a href="delete_college.php">GO BACK</a><br><br></font></p>';
				}
			}
			else
			{
