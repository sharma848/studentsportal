...
<title>Students Portal - View College Data</title>
...
<div id="container">
    ...
    <div id="nav">
    	<ul class="sf-menu dropdown">
            ...
            <li class="selected"><a  href="view_college.php">View College Data</a></li>
...
<?php
	...
	{
		$query="SELECT college_details.college_id,college_name, branch_name FROM college_details,branch_details WHERE college_details.college_id=branch_details.college_id";
		$query_run=mysql_query($query);
		$query_num= mysql_num_rows($query_run);
		$count=1;
		if($query_num>0)
		{
			echo '<br><br><table align="center" ><tbody><tr><th>S. No.</th> <th>College ID</th><th>College Name</th> <th id="msg">Branch Offered</th> </tr>';
			while($query_row=mysql_fetch_assoc($query_run)){
				echo '<tr><td>'.$count.'</td><td>'.$query_row['college_id'].'</td><td>'.$query_row['college_name'].'</td><td>'.$query_row['branch_name'].'</td></tr>';
				$count=$count+1;
			}
			echo '</table></tbody><br><br><br>';
		}
		else
		{
			echo '<p align="center"><font color="red"><br /><br /> No record to display!! <br> </font></p><br><br>';
		} 
	}
?>
</div>
